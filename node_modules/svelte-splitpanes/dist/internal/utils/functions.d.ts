 ...
 */
export declare const carefullCallbackSource: <CallbacksObject extends object>(callbackObjectGetter: () => CallbacksObject) => <Callback extends keyof CallbacksObject>(callbackName: Callback) => CallbacksObject[Callback];
