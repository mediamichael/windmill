...
<script strictEvents>import { onMount, onDestroy, setContext, createEventDispatcher, tick, afterUpdate } from 'svelte';
...
<style global>:global(div.splitpanes--horizontal.splitpanes--dragging) {
  cursor: row-resize;
}
