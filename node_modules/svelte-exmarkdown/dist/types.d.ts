...
export type ComponentsMap = Record<string, Component | string | null | undefined>;
export type Plugin = {
...
export type HastLiteral = HastBase & {
    value: string;
};
...
export type HastDoctype = HastBase & {
    type: 'doctype';
};
...
export type HastRaw = HastLiteral & {
    type: 'raw';
};
export type HastNode = HastRoot | HastElement | HastDoctype | HastComment | HastText | HastRaw;
