...
export class LanguageService {
    ...
    _parseOptions = undefined;
    _customValidationRules = undefined;
    ...
    getCompletion = (uri, documentText, position) => {
        ...
        return getAutocompleteSuggestions(schema.schema, documentText, position, undefined, this.getExternalFragmentDefinitions(), { uri, fillLeafsOnComplete: this._fillLeafsOnComplete });
    };
