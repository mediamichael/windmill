...
var LanguageService = (function () {
    function LanguageService(_a) {
        var parser = _a.parser, schemas = _a.schemas, parseOptions = _a.parseOptions, externalFragmentDefinitions = _a.externalFragmentDefinitions, customValidationRules = _a.customValidationRules, fillLeafsOnComplete = _a.fillLeafsOnComplete, completionSettings = _a.completionSettings;
        var _this = this;
        var _b;
        ...
        this.getCompletion = function (uri, documentText, position) {
            ...
            return (0, graphql_language_service_1.getAutocompleteSuggestions)(schema.schema, documentText, position, undefined, _this.getExternalFragmentDefinitions(), __assign({ uri: uri }, _this._completionSettings));
        };
        ...
        this._completionSettings = __assign(__assign({}, completionSettings), { fillLeafsOnComplete: (_b = completionSettings === null || completionSettings === void 0 ? void 0 : completionSettings.fillLeafsOnComplete) !== null && _b !== void 0 ? _b : fillLeafsOnComplete });
        if (parseOptions) {
