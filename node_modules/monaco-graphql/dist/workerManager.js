        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                ...
                if (!this._client && !this._worker) {
                    try {
                        this._worker = monaco_editor_1.editor.createWebWorker({
                            ...
                            createData: {
                                ...
                                languageConfig: {
                                    schemas: (_a = this._defaults.schemas) === null || _a === void 0 ? void 0 : _a.map(utils_1.getStringSchema),
    ...
    WorkerManager.prototype.getLanguageServiceWorker = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this._getClient()];
                    case 1:
                        client = _a.sent();
                        return [4, this._worker.withSyncedResources(resources)];
                    case 2:
                        _a.sent();
                        return [2, client];
                }
